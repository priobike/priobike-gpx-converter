...
def fetch_city_map(min_lat, min_lng, max_lat, max_lng, style="satellite-streets-v12"):
    """
    ...
    url = f"https://api.mapbox.com/styles/v1/mapbox/{style}/static/[{min_lng},{min_lat},{max_lng},{max_lat}]/1000x1000?" \
        + f"padding=0" \
        + f"&@2x" \
